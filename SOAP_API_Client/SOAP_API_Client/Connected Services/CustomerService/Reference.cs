...
namespace CustomerService
{
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="CustomerDataContract", Namespace="http://schemas.datacontract.org/2004/07/SOAP_API.Models")]
    ...
    public interface ICustomerService
    {
        ...
        CustomerService.CustomerDataContract GetCustomers();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ICustomerService/GetCustomers", ReplyAction="http://tempuri.org/ICustomerService/GetCustomersResponse")]
        System.Threading.Tasks.Task<CustomerService.CustomerDataContract> GetCustomersAsync();
    }
    ...
    public partial class CustomerServiceClient : System.ServiceModel.ClientBase<CustomerService.ICustomerService>, CustomerService.ICustomerService
    {
        ...
        public CustomerService.CustomerDataContract GetCustomers()
        {
            return base.Channel.GetCustomers();
        }
        
        public System.Threading.Tasks.Task<CustomerService.CustomerDataContract> GetCustomersAsync()
        {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ICustomerService))
            {
                return new System.ServiceModel.EndpointAddress("https://localhost:7044/CustomerService.asmx");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
